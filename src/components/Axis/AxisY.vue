<template>
  <g v-if="axisY.length">
    <g v-for="(price, index) in axisY" :transform="`translate(0, ${price.y + chartOffset})`" :key="index">
      <line x1="0" :x2="chartWidth - 70" class="axis-x" opacity="0.1"></line>
      <line :x1="chartWidth - 70" :x2="chartWidth" class="axis-x" opacity="0.08" stroke-dasharray="2"></line>
    ...
    <line :x1="chartWidth - 70" :x2="chartWidth - 70" :y1="chartOffset" :y2="chartHeight + chartOffset" class="axis-x" opacity="0.1"></line>
  </g>
</template>
