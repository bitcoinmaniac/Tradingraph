...
// CONCATENATED MODULE: ./src/App.vue?vue&type=template&id=387583b1&
...
/* harmony default export */ var Appvue_type_script_lang_js_ = ({
  ...
  watch: {
    ...
    indicatorsData: {
      handler: function handler() {
        ...
        this.indicatorsPaths = Object.keys(this.indicatorsData).map(function (key) {
          return _this.indicatorsData[key].join(' ');
        });
      },
      deep: true
    },
    ...
    isMenuOpen: function isMenuOpen(value) {
      console.log(value);
    }
  },
  created: function created() {
    ...
    findHoverCandle: function findHoverCandle() {
      ...
      if (this.candles) {
        this.candles.candles.map(function (candle) {
          if (_this2.interactive.cursorX >= candle.x - _this2.candles.width * 0.25 && _this2.interactive.cursorX <= candle.x + _this2.candles.width * 0.25) {
            _this2.interactive.hoverCandle = candle;
          }
        });
      }
    },
