              ...
              case 'indicators':
                {
                  ...
                  this.indicatorsPaths = Object.keys(this.indicatorsData).map(function (key) {
                    if (_this.indicatorsData[key]) {
                      return _this.indicatorsData[key];
                    } else {
                      return '';
                    }
                  });
