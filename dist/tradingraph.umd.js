              ...
              case 'indicators':
                {
                  ...
                  this.indicatorDisplayableData = Object.keys(message.data.body.data.indicators).map(function (key) {
